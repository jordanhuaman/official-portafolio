...
export default function Home() {
  ...
  return (
    <ScrollProvider scrollRef={scrollRef}>
      <main className="flex flex-col md:flex-row min-h-screen mx-auto max-w-screen-xl">
        <section className="w-full md:w-1/2 md:sticky md:top-0 md:h-screen md:flex md:flex-col md:justify-between py-20 px-20">
          <PresentationView />
          <InfoFixedLeft />
        </section>
