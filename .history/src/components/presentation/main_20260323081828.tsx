  ...
  return (
    <div className="flex flex-1 justify-center items-center mx-auto max-w-[1000px] px-10 sm:px-20">
      <div>
        ...
        <p className={`text-[25px] md:text-[60px] opacity-[0.6] ${helpers.title_1} leading-[0.9]`}>I Build things for the server</p>
        <div className='mt-[20px] max-w-[70%] flex flex-col gap-4'>
          <p className={`text-slate  tracking-wide inline ${helpers.normal_text}`}>Ingeniero de Sistemas</p>
          <p className={`text-slate  tracking-wide inline ${helpers.normal_text}`}>2 aṅos como desarrollador Backend</p>
          <p className={`text-slate  tracking-wide inline ${helpers.normal_text}`}>Aprendiendo cloud y DevOps</p>
        </div>
