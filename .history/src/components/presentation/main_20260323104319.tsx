...
const Main = () => {
  ...
  return (
    <div className="flex flex-1 justify-center items-center mx-auto  px-10 sm:px-20">
      <div>
        ...
        <p className={`text-[25px] md:text-[60px] opacity-[0.6] ${helpers.title_1} leading-[0.9]`}>{t('hero.subtitle')}</p>
